//#region gadgets/CollapseJump/index.js
(function() {
	function collapseJump() {
		...
		function jumpToLabel(label) {
			...
			if (!parent.classList.contains("mw-collapsible-toggle-expanded")) $(parent.parentElement).data("mw-collapsible").expand();
		...
		for (let label of labels) {
			...
			if (hash && hash !== "") compare.push(processText(hash));

	...
	var PRA = {
		...
		initialize: function(i18nLoader) {
			...
			if (PRA.wg.wgCanonicalSpecialPageName === "Blankpage" && mw.util.getParamValue("blankspecial") === "pageusageupdate") {
				if (mw.loader.getState(".FandoomUiUtilsDorui") === null) importScriptURI("https://cdn.jsdelivr.net/gh/ccxtwf/MirahezeDevScripts@1776669844/dist/FandoomUiUtilsDorui/gadget-impl.js");

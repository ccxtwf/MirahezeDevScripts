...
(function($, mw) {
	...
	*/
	function createPowerEditorToolboxPortletForCitizen() {
		...
		}).append($("<span>", { "class": "powertools-icon" }).append(TOOLBOX_ICON), $("<span>").text(POWER_EDITOR_TOOLBOX_PORTLET_HEADING_TEXT))), $("<div>", {
